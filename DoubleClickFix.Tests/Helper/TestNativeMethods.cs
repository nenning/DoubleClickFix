...
class TestNativeMethods : INativeMethods {
	...
	public nint GetWindowLong(nint hWnd, int nIndex) => throw new NotImplementedException();

	public nint SetWindowLong(nint hWnd, int nIndex, nint dwNewLong) => throw new NotImplementedException();
